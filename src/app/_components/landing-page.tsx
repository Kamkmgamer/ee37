        ...
        <header className="flex items-center justify-between px-6 py-5">
          ...
          <div className="flex items-center gap-4">
            {user ? (
              ...
              <Link
                href="/login"
                className="flex items-center gap-2 rounded-full bg-[var(--color-midnight)] px-4 py-2 text-sm font-medium text-[var(--color-gold)] transition-transform hover:scale-105"
              >
